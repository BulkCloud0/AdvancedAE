...
public final class AAEBlocks extends BlockRegistry {
    ...
    AAEBlocks() { super(AdvancedAE.MOD_ID); }
    ...
    public static final LibBlockDefinition<AEDecorativeBlock> REACTION_CHAMBER = placeholder("Reaction Chamber", "reaction_chamber");
    public static final LibBlockDefinition<AEDecorativeBlock> QUANTUM_CRAFTER = placeholder("Quantum Crafter", "quantum_crafter");

    private static LibBlockDefinition<AEDecorativeBlock> placeholder(String name, String id) {
        return block(name, id, () -> new AEDecorativeBlock(stoneProps()), AEBaseBlockItem::new);
    }
