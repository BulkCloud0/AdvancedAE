...
public class PatternSlot extends AppEngSlot {
    ...
    private final AutoCrafterContainerRecord machineInv;

    public PatternSlot(AutoCrafterContainerRecord machineInv, int machineInvSlot, int x, int y) {
    ...
    public AutoCrafterContainerRecord getMachineInv() {
